...
| `lifecycle.requestAcceptGraceTimeout` | The duration to keep accepting requests after initiating a shutdown before starting the graceful termination period.          | `"0"`                                             |
| `lifecycle.graceTimeOut`               | The amount of time to allow running requests to finish when doing a graceful termination.                                    | `"10s"`                                           |
